...
/**
 * A mint the Pangu program holds no sale for, or a read the chain did not answer.
  ...
  return (
    ...
    >
      ...
      <p className="font-mono text-[10px] uppercase tracking-[0.22em] text-muted">
        {unanswered ? `${CHAIN.inSentence} did not answer` : "no sale at this address"}
      </p>
      ...
      <p className="mt-8 max-w-[52ch] text-[16px] leading-relaxed text-muted">
        {unanswered
          ...
          : `The Pangu program on ${CHAIN.inSentence} holds no rules for this mint, so there is nothing to buy here. Check the address, or pick a sale from the list.`}
      </p>
